        ...
        <nav className="container  flex h-[70px] items-center justify-between py-2 ">
          <div className="text-2xl text-white md:text-3xl ">
            <a href="/#home" className="">
              RO
              <span className="inline-block font-bold text-primary">CK</span>
            </a>
          </div>
          {/* Desktop Menu */}
                ...
                <div className="absolute left-0 z-[9999] hidden w-full rounded-b-3xl bg-white p-2 text-black group-hover:block  ">
                  <div className="grid grid-cols-3 gap-5 ">
                    ...
                    <div className="col-span-2">
                      <h1 className="pb-3 text-xl text-indigo-800 font-semibold">
                        OUR SERVICES
                      </h1>
                      <p className="text-sm text-slate-600">
                        We offer expertise in a wide range of areas, including custom web design, mobile app development, blockchain technology, and NFT solutions.
                      </p>
