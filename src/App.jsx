...
import BannerDetail1 from "./components/BannerDetails/BannerDetails1";
import BannerDetail2 from "./components/BannerDetails/BannerDetails2";
  ...
  return (
    <>
      <div className="dark:bg-slate-900 dark:text-white">
        ...
        <Hero />
        <Service />
        <BannerDetail1 reverse={true} img={Banner1} />
        <BannerDetail2 img={Banner2} />
        <Banner />
        <Blogs />
        {/* <Swipe /> */}
        <Footer />
